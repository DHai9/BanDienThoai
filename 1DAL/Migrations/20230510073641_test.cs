    ...
    public partial class test : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Hà Nam", 1, 1, new DateTime(2023, 5, 10, 14, 36, 40, 595, DateTimeKind.Local).AddTicks(7040), "0336253482", "Ngô Quốc Mạnh", 0, "123" });

            migrationBuilder.InsertData(
                table: "NhanVien",
                columns: new[] { "MaNV", "DiaChi", "GioiTinh", "MaCV", "NgaySinh", "SDT", "TenNV", "TrangThai", "matKhau" },
                values: new object[] { 2, "Tuyên Quang", 1, 2, new DateTime(2023, 5, 10, 14, 36, 40, 595, DateTimeKind.Local).AddTicks(7025), "0379702133", "Nguyễn Văn Đạo", 0, "123" });
